...
const { createRequire } = require("module"); const { createRequire: createRequireImport } from "module";
const require = createRequire(import.meta.url);
// index.js is CommonJS, so we use require
const { format: napiFormat } = require("./index.js");
import { resolvePlugins, formatEmbeddedCode, formatFile } from "./libs/prettier.mjs";
